...
--
-- Name: musicians_info_1; Type: TABLE; Schema: public; Owner: mark
--

CREATE TABLE public.musicians_info_1 (
    id integer NOT NULL,
    name character varying(30) NOT NULL,
...
ALTER TABLE public.musicians_info_1 OWNER TO mark;

--
-- Name: musicians_info_1_id_seq; Type: SEQUENCE; Schema: public; Owner: mark
--

CREATE SEQUENCE public.musicians_info_1_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.musicians_info_1_id_seq OWNER TO mark;

--
-- Name: musicians_info_1_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: mark
--

ALTER SEQUENCE public.musicians_info_1_id_seq OWNED BY public.musicians_info_1.id;
...
--
-- Name: musicians_info_1 id; Type: DEFAULT; Schema: public; Owner: mark
--

ALTER TABLE ONLY public.musicians_info_1 ALTER COLUMN id SET DEFAULT nextval('public.musicians_info_1_id_seq'::regclass);
...
--
-- Data for Name: musicians_info_1; Type: TABLE DATA; Schema: public; Owner: mark
--

COPY public.musicians_info_1 (id, name, gender, birthplace, birthdate) FROM stdin;
...
SELECT pg_catalog.setval('public.musicians_favorites_id_seq', 1, false);


--
-- Name: musicians_info_1_id_seq; Type: SEQUENCE SET; Schema: public; Owner: mark
--

SELECT pg_catalog.setval('public.musicians_info_1_id_seq', 1, false);
...
--
-- Name: musicians_info_1 musicians_info_1_pkey; Type: CONSTRAINT; Schema: public; Owner: mark
--

ALTER TABLE ONLY public.musicians_info_1
    ADD CONSTRAINT musicians_info_1_pkey PRIMARY KEY (id);
